...
RSpec.describe RecipesController, type: :controller do
  ...
  let(:valid_attributes) { { name: 'Recipe', preparation: 'prep' } }
  let(:invalid_attributes) { { name: '', preparation: 'prep' } }
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      let(:new_attributes) {
        { name: 'Recipe 2', preparation: 'prep 2'}
      }
      ...
      it 'updates the requested recipe' do
        ...
        recipe.reload
        expect(recipe.name).to eq('Recipe 2')
      end
